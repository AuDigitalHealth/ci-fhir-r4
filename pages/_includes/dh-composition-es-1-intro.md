#### Australian Digital Health Agency Event Summary Document Composition
...
* Query for a Event Summary document for a patient
* Record or update a Event Summary document for a patient
