...
* It SHALL be a valid HL7 FHIR instance. In particular:
    * It SHALL conform to [FHIR, Release 4 (v{{ site.data.fhir.version }}) [HL7FHIR4]](index.html#HL7FHIR4)
    * It SHALL conform to the profile it claims conformance to including:
        ...
        * conforming to the requirements in the base resource as specified in [FHIR, Release 4 (v{{ site.data.fhir.version }}) [HL7FHIR4]](index.html#HL7FHIR4)
...
* A derived profile SHALL be derived in accordance with the rules on profiling in [FHIR, Release 4 (v{{ site.data.fhir.version }}) [HL7FHIR4]](index.html#HL7FHIR4)
